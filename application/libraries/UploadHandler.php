...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/files/'.$CI->session->userdata('username').'/',
            'upload_url' => $this->get_full_url().'/files/'.$CI->session->userdata('username').'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function set_file_delete_properties($file) {
        ...
        $file->delete_url = site_url('upload/do_upload')
            .$this->get_query_separator($this->options['script_url'])
