<div class="container row">
    ...
    <div class="span2 offset9">
        <div class="btn-group row">
            <button class="btn btn-inverse"><?php echo $this->session->userdata('username'); ?></button>
            <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown">
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu">
                <li><?php echo anchor('login/logout', 'Sign out'); ?></li>
                <li><?php echo anchor('login/profile_settings', 'Profile Settings'); ?></li>
            </ul>
        </div>
    </div>
